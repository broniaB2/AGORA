/**
 * FILE: src/pages/Screening.jsx
 *
 * HOW TO POPULATE:
 *   1. Open Screening.html (already downloaded in this project).
 *   2. Copy everything inside <body> into the return() below as JSX.
 *   3. Move <style> block into Screening.module.css and import it.
...
export default function Screening() {
  ...
  return (
    <div className="page fade-in">
      {/* TODO: paste JSX from Screening.html here */}
      <h1 style={{ fontFamily: 'var(--font-display)', color: 'var(--gray-800)' }}>
        Screening
      </h1>
      <p style={{ color: 'var(--gray-500)', marginTop: 8 }}>
        Paste content from Screening.html — see file header for instructions.
      </p>
    </div>
  )
}
