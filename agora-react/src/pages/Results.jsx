 ...
 *
 * HOW TO POPULATE:
 *   1. Open Results.html (already downloaded in this project).
 *   2. Copy everything inside <body> into the return() below as JSX.
 *   3. Move <style> block into Results.module.css and import it.
...
export default function Results() {
  ...
  return (
    <div className="page fade-in">
      {/* TODO: paste JSX from Results.html here */}
      <h1 style={{ fontFamily: 'var(--font-display)', color: 'var(--gray-800)' }}>
        Results
      </h1>
      <p style={{ color: 'var(--gray-500)', marginTop: 8 }}>
        Paste content from Results.html — see file header for instructions.
      </p>
    </div>
  )
}
