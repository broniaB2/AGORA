 ...
 *
 * HOW TO POPULATE:
 *   1. Open Dashboard.html (already downloaded in this project).
 *   2. Copy everything inside <body> into the return() below as JSX.
 *   3. Move <style> block into Dashboard.module.css and import it.
...
export default function Dashboard() {
  ...
  return (
    <div className="page fade-in">
      {/* TODO: paste JSX from Dashboard.html here */}
      <h1 style={{ fontFamily: 'var(--font-display)', color: 'var(--gray-800)' }}>
        Dashboard
      </h1>
      <p style={{ color: 'var(--gray-500)', marginTop: 8 }}>
        Paste content from Dashboard.html — see file header for instructions.
      </p>
    </div>
  )
}
